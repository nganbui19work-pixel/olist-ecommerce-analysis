...
--theres difference in total orders recorded in orders table and order_items table
...
ORDER BY order_count DESC; --reasons because order_status is unavailable, cancelled or only just created
...
-- Seasonality Analysis - Monthly Pattern
SELECT 
